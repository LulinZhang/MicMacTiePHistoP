...
* [2. Inter-epoch processing](#2-inter-epoch-processing)
   * [2.1. Automated pipeline](#21-automated-pipeline)
      * [2.1.1. Option 1: SuperGlue](#211-option-1-superglue)
         * [Recover inter-epoch tie-points](#recover-inter-epoch-tie-points)
         * [Visualize an example of inter-epoch tie-points](#visualize-an-example-of-inter-epoch-tie-points)
         * [Visualize all the inter-epoch tie-points](#visualize-all-the-inter-epoch-tie-points)
      * [2.1.2. Option 2: SIFT](#212-option-2-sift)
         * [Recover inter-epoch tie-points](#recover-inter-epoch-tie-points-1)
         * [Visualize an example of inter-epoch tie-points](#visualize-an-example-of-inter-epoch-tie-points-1)
         * [Visualize all the inter-epoch tie-points](#visualize-all-the-inter-epoch-tie-points-1)
